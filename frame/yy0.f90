...
SUBROUTINE nl_get_use_sh_qv ( id_id , use_sh_qv )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: use_sh_qv
  INTEGER id_id
  use_sh_qv = model_config_rec%use_sh_qv
  RETURN
END SUBROUTINE nl_get_use_sh_qv
...
SUBROUTINE nl_get_write_thompson_mp38table ( id_id , write_thompson_mp38table )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: write_thompson_mp38table
  INTEGER id_id
  write_thompson_mp38table = model_config_rec%write_thompson_mp38table
  RETURN
...
SUBROUTINE nl_get_nssl_icdx ( id_id , nssl_icdx )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_icdx
  INTEGER id_id
  nssl_icdx = model_config_rec%nssl_icdx
  RETURN
END SUBROUTINE nl_get_nssl_icdx
SUBROUTINE nl_get_nssl_icdxhl ( id_id , nssl_icdxhl )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_icdxhl
  INTEGER id_id
  nssl_icdxhl = model_config_rec%nssl_icdxhl
  RETURN
END SUBROUTINE nl_get_nssl_icdxhl
SUBROUTINE nl_get_nssl_hail_on ( id_id , nssl_hail_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_hail_on
  INTEGER id_id
  nssl_hail_on = model_config_rec%nssl_hail_on
  RETURN
END SUBROUTINE nl_get_nssl_hail_on
SUBROUTINE nl_get_nssl_ccn_on ( id_id , nssl_ccn_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_ccn_on
  INTEGER id_id
  nssl_ccn_on = model_config_rec%nssl_ccn_on
  RETURN
END SUBROUTINE nl_get_nssl_ccn_on
SUBROUTINE nl_get_nssl_ccn_is_ccna ( id_id , nssl_ccn_is_ccna )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_ccn_is_ccna
  INTEGER id_id
  nssl_ccn_is_ccna = model_config_rec%nssl_ccn_is_ccna
  RETURN
END SUBROUTINE nl_get_nssl_ccn_is_ccna
SUBROUTINE nl_get_nssl_2moment_on ( id_id , nssl_2moment_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_2moment_on
  INTEGER id_id
  nssl_2moment_on = model_config_rec%nssl_2moment_on
  RETURN
END SUBROUTINE nl_get_nssl_2moment_on
SUBROUTINE nl_get_nssl_3moment ( id_id , nssl_3moment )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_3moment
  INTEGER id_id
  nssl_3moment = model_config_rec%nssl_3moment
  RETURN
END SUBROUTINE nl_get_nssl_3moment
SUBROUTINE nl_get_nssl_density_on ( id_id , nssl_density_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_density_on
  INTEGER id_id
  nssl_density_on = model_config_rec%nssl_density_on
  RETURN
END SUBROUTINE nl_get_nssl_density_on
SUBROUTINE nl_get_nssl_ssat_output ( id_id , nssl_ssat_output )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: nssl_ssat_output
  INTEGER id_id
  nssl_ssat_output = model_config_rec%nssl_ssat_output
  RETURN
END SUBROUTINE nl_get_nssl_ssat_output
...
SUBROUTINE nl_get_tke_budget ( id_id , tke_budget )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: tke_budget
  INTEGER id_id
  tke_budget = model_config_rec%tke_budget(id_id)
  RETURN
END SUBROUTINE nl_get_tke_budget
...
SUBROUTINE nl_get_bl_mynn_closure ( id_id , bl_mynn_closure )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: bl_mynn_closure
  INTEGER id_id
  bl_mynn_closure = model_config_rec%bl_mynn_closure
  RETURN
END SUBROUTINE nl_get_bl_mynn_closure
...
SUBROUTINE nl_get_default_soiltype ( id_id , default_soiltype )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: default_soiltype
  INTEGER id_id
  default_soiltype = model_config_rec%default_soiltype
  RETURN
END SUBROUTINE nl_get_default_soiltype
