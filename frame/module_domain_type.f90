...
TYPE(fdob_type)                               :: fdob
integer                                  :: windfarm_wake_model
integer                                  :: windfarm_overlap_method
real                                     :: windfarm_deg
...
real                                     :: fire_ext_grnd
real                                     :: fire_ext_crwn
integer                                  :: fire_sfc_flx
real                                     :: fire_heat_peak
real                                     :: fire_tg_ub
integer                                  :: fire_smk_scheme
real                                     :: fire_smk_peak
real                                     :: fire_smk_ext
...
real                                     :: z_lev_missing
real                                     :: z_lev_interval
character*256                               :: iau_time
integer                                  :: iau
real                                     :: iau_time_window_sec
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: acoustic_grad_u
real      ,DIMENSION(:,:,:)   ,POINTER   :: acoustic_grad_v
real      ,DIMENSION(:,:,:)   ,POINTER   :: acoustic_grad_w
real      ,DIMENSION(:,:,:)   ,POINTER   :: acoustic_grad_p
...
real      ,DIMENSION(:,:)     ,POINTER   :: acoustic_cfl_max
real      ,DIMENSION(:,:)     ,POINTER   :: acoustic_dt_factor
...
real      ,DIMENSION(:,:)     ,POINTER   :: zd_urb2d
real      ,DIMENSION(:,:)     ,POINTER   :: z0_urb2d
real      ,DIMENSION(:,:)     ,POINTER   :: lf_urb2d_s
real      ,DIMENSION(:,:,:)   ,POINTER   :: ahe
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: pek_pbl
...
real      ,DIMENSION(:,:)     ,POINTER   :: maxwidth
real      ,DIMENSION(:,:)     ,POINTER   :: ztop_plume
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: diss_pbl
real      ,DIMENSION(:,:,:)   ,POINTER   :: tpe_pbl
real      ,DIMENSION(:,:,:)   ,POINTER   :: pr_pbl
...
real      ,DIMENSION(:,:)     ,POINTER   :: o3_gfs_du
...
real      ,DIMENSION(:,:,:)   ,POINTER   :: ssat
real      ,DIMENSION(:,:,:)   ,POINTER   :: ssati
...
real      ,DIMENSION(:,:)     ,POINTER   :: haildtacttime
...
real      ,DIMENSION(:,:)     ,POINTER   :: cloudnc
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_u_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_v_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_w_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_t_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_ph_btye
real      ,DIMENSION(:,:)     ,POINTER   :: k1_mu
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k1_mu_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_u_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_v_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_w_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_t_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_ph_btye
real      ,DIMENSION(:,:)     ,POINTER   :: k2_mu
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k2_mu_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_u_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_v_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_w_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_t_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_ph_btye
real      ,DIMENSION(:,:)     ,POINTER   :: k3_mu
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: k3_mu_btye
...
integer   ,DIMENSION(:)       ,POINTER   :: fs_p_src
...
real      ,DIMENSION(:,:)     ,POINTER   :: mu_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: u_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: v_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: w_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: p_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: t_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: ph_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qv_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qr_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qc_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qs_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qi_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: qg_iau
real      ,DIMENSION(:,:,:)   ,POINTER   :: ruiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rviauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rthiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rphiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqviauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqciauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqriauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqiiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqsiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: rqgiauten
real      ,DIMENSION(:,:)     ,POINTER   :: rmuiauten
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k1_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k2_btye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_bxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_bxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_bys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_bye
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_btxs
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_btxe
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_btys
real      ,DIMENSION(:,:,:)   ,POINTER   :: sdirk3_k3_btye
