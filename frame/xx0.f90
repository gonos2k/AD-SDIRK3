...
SUBROUTINE nl_set_use_sh_qv ( id_id , use_sh_qv )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(IN) :: use_sh_qv
  INTEGER id_id
  model_config_rec%use_sh_qv = use_sh_qv 
  RETURN
END SUBROUTINE nl_set_use_sh_qv
...
SUBROUTINE nl_set_write_thompson_mp38table ( id_id , write_thompson_mp38table )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(IN) :: write_thompson_mp38table
  INTEGER id_id
  model_config_rec%write_thompson_mp38table = write_thompson_mp38table 
  RETURN
END SUBROUTINE nl_set_write_thompson_mp38table
...
SUBROUTINE nl_set_nssl_cccn ( id_id , nssl_cccn )
  ...
  INTEGER id_id
  model_config_rec%nssl_cccn = nssl_cccn 
  RETURN
...
SUBROUTINE nl_set_nssl_alphah ( id_id , nssl_alphah )
  ...
  INTEGER id_id
  model_config_rec%nssl_alphah = nssl_alphah 
  RETURN
...
SUBROUTINE nl_set_nssl_alphahl ( id_id , nssl_alphahl )
  ...
  INTEGER id_id
  model_config_rec%nssl_alphahl = nssl_alphahl 
  RETURN
...
SUBROUTINE nl_set_nssl_cnoh ( id_id , nssl_cnoh )
  ...
  INTEGER id_id
  model_config_rec%nssl_cnoh = nssl_cnoh 
  RETURN
...
SUBROUTINE nl_set_nssl_cnohl ( id_id , nssl_cnohl )
  ...
  INTEGER id_id
  model_config_rec%nssl_cnohl = nssl_cnohl 
  RETURN
...
SUBROUTINE nl_set_nssl_cnos ( id_id , nssl_cnos )
  ...
  INTEGER id_id
  model_config_rec%nssl_cnos = nssl_cnos 
  RETURN
...
SUBROUTINE nl_set_nssl_rho_qh ( id_id , nssl_rho_qh )
  ...
  INTEGER id_id
  model_config_rec%nssl_rho_qh = nssl_rho_qh 
  RETURN
...
SUBROUTINE nl_set_nssl_rho_qhl ( id_id , nssl_rho_qhl )
  ...
  INTEGER id_id
  model_config_rec%nssl_rho_qhl = nssl_rho_qhl 
  RETURN
...
SUBROUTINE nl_set_nssl_rho_qs ( id_id , nssl_rho_qs )
  ...
  INTEGER id_id
  model_config_rec%nssl_rho_qs = nssl_rho_qs 
  RETURN
END SUBROUTINE nl_set_nssl_rho_qs
SUBROUTINE nl_set_nssl_icdx ( id_id , nssl_icdx )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_icdx
  INTEGER id_id
  model_config_rec%nssl_icdx = nssl_icdx 
  RETURN
END SUBROUTINE nl_set_nssl_icdx
SUBROUTINE nl_set_nssl_icdxhl ( id_id , nssl_icdxhl )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_icdxhl
  INTEGER id_id
  model_config_rec%nssl_icdxhl = nssl_icdxhl 
  RETURN
END SUBROUTINE nl_set_nssl_icdxhl
SUBROUTINE nl_set_nssl_hail_on ( id_id , nssl_hail_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_hail_on
  INTEGER id_id
  model_config_rec%nssl_hail_on = nssl_hail_on 
  RETURN
END SUBROUTINE nl_set_nssl_hail_on
SUBROUTINE nl_set_nssl_ccn_on ( id_id , nssl_ccn_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_ccn_on
  INTEGER id_id
  model_config_rec%nssl_ccn_on = nssl_ccn_on 
  RETURN
END SUBROUTINE nl_set_nssl_ccn_on
SUBROUTINE nl_set_nssl_ccn_is_ccna ( id_id , nssl_ccn_is_ccna )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_ccn_is_ccna
  INTEGER id_id
  model_config_rec%nssl_ccn_is_ccna = nssl_ccn_is_ccna 
  RETURN
END SUBROUTINE nl_set_nssl_ccn_is_ccna
SUBROUTINE nl_set_nssl_2moment_on ( id_id , nssl_2moment_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_2moment_on
  INTEGER id_id
  model_config_rec%nssl_2moment_on = nssl_2moment_on 
  RETURN
END SUBROUTINE nl_set_nssl_2moment_on
SUBROUTINE nl_set_nssl_3moment ( id_id , nssl_3moment )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_3moment
  INTEGER id_id
  model_config_rec%nssl_3moment = nssl_3moment 
  RETURN
END SUBROUTINE nl_set_nssl_3moment
SUBROUTINE nl_set_nssl_density_on ( id_id , nssl_density_on )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_density_on
  INTEGER id_id
  model_config_rec%nssl_density_on = nssl_density_on 
  RETURN
END SUBROUTINE nl_set_nssl_density_on
SUBROUTINE nl_set_nssl_ssat_output ( id_id , nssl_ssat_output )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: nssl_ssat_output
  INTEGER id_id
  model_config_rec%nssl_ssat_output = nssl_ssat_output 
  RETURN
END SUBROUTINE nl_set_nssl_ssat_output
...
SUBROUTINE nl_set_tke_budget ( id_id , tke_budget )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: tke_budget
  INTEGER id_id
  model_config_rec%tke_budget(id_id) = tke_budget
  RETURN
END SUBROUTINE nl_set_tke_budget
...
SUBROUTINE nl_set_bl_mynn_closure ( id_id , bl_mynn_closure )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(IN) :: bl_mynn_closure
  INTEGER id_id
  model_config_rec%bl_mynn_closure = bl_mynn_closure 
  RETURN
END SUBROUTINE nl_set_bl_mynn_closure
...
SUBROUTINE nl_set_default_soiltype ( id_id , default_soiltype )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(IN) :: default_soiltype
  INTEGER id_id
  model_config_rec%default_soiltype = default_soiltype 
  RETURN
END SUBROUTINE nl_set_default_soiltype
