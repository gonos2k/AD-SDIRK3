...
SUBROUTINE HALO_EM_SDIRK3_K1_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_EM_SDIRK3_K1_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k1_v,1)*SIZE(grid%k1_v,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k1_v, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k1_w,1)*SIZE(grid%k1_w,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k1_w, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k1_t,1)*SIZE(grid%k1_t,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k1_t, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k1_mu,1)*SIZE(grid%k1_mu,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k1_mu, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, 1  , 1                )
ENDIF
IF ( SIZE(grid%k1_ph,1)*SIZE(grid%k1_ph,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k1_ph, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_EM_SDIRK3_K1_sub
...
SUBROUTINE HALO_EM_SDIRK3_K2_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_EM_SDIRK3_K2_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k2_v,1)*SIZE(grid%k2_v,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k2_v, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k2_w,1)*SIZE(grid%k2_w,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k2_w, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k2_t,1)*SIZE(grid%k2_t,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k2_t, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k2_mu,1)*SIZE(grid%k2_mu,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k2_mu, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, 1  , 1                )
ENDIF
IF ( SIZE(grid%k2_ph,1)*SIZE(grid%k2_ph,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k2_ph, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_EM_SDIRK3_K2_sub
...
SUBROUTINE HALO_EM_SDIRK3_K3_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_EM_SDIRK3_K3_inline.inc')
CALL rsl_comm_iter_init(1,jps,jpe)
DO WHILE ( rsl_comm_iter( grid%id , grid%is_intermediate, 1 , &
                         0 , jds,jde,jps,jpe, grid%njds, grid%njde , & 
     rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p,   & 
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k3_v,1)*SIZE(grid%k3_v,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k3_v, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k3_w,1)*SIZE(grid%k3_w,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k3_w, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k3_t,1)*SIZE(grid%k3_t,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k3_t, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, kps, kpe              )
ENDIF
IF ( SIZE(grid%k3_mu,1)*SIZE(grid%k3_mu,2) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k3_mu, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
ips, ipe, jps, jpe, 1  , 1                )
ENDIF
IF ( SIZE(grid%k3_ph,1)*SIZE(grid%k3_ph,3) .GT. 1 ) THEN
CALL RSL_LITE_PACK ( local_communicator,&
 grid%k3_ph, 1,&
rsl_sendbeg_m, rsl_sendw_m, rsl_sendbeg_p, rsl_sendw_p, &
rsl_recvbeg_m, rsl_recvw_m, rsl_recvbeg_p, rsl_recvw_p, &
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_EM_SDIRK3_K3_sub
...
SUBROUTINE HALO_EM_SDIRK3_WORK_sub ( grid, &
  local_communicator, &
  mytask, ntasks, ntasks_x, ntasks_y, &
  ids, ide, jds, jde, kds, kde,       &
  ims, ime, jms, jme, kms, kme,       &
...
CALL wrf_debug(2,'calling inc/HALO_EM_SDIRK3_WORK_inline.inc')
...
CALL pop_communicators_for_domain
  ...
  END SUBROUTINE HALO_EM_SDIRK3_WORK_sub
