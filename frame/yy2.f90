...
SUBROUTINE nl_get_time_integration_scheme ( id_id , time_integration_scheme )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: time_integration_scheme
  INTEGER id_id
  time_integration_scheme = model_config_rec%time_integration_scheme
  RETURN
END SUBROUTINE nl_get_time_integration_scheme
SUBROUTINE nl_get_sdirk3_max_newton_iter ( id_id , sdirk3_max_newton_iter )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_max_newton_iter
  INTEGER id_id
  sdirk3_max_newton_iter = model_config_rec%sdirk3_max_newton_iter
  RETURN
END SUBROUTINE nl_get_sdirk3_max_newton_iter
SUBROUTINE nl_get_sdirk3_newton_tol ( id_id , sdirk3_newton_tol )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_newton_tol
  INTEGER id_id
  sdirk3_newton_tol = model_config_rec%sdirk3_newton_tol
  RETURN
END SUBROUTINE nl_get_sdirk3_newton_tol
SUBROUTINE nl_get_sdirk3_dt_min_factor ( id_id , sdirk3_dt_min_factor )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_dt_min_factor
  INTEGER id_id
  sdirk3_dt_min_factor = model_config_rec%sdirk3_dt_min_factor
  RETURN
END SUBROUTINE nl_get_sdirk3_dt_min_factor
SUBROUTINE nl_get_sdirk3_dt_max_factor ( id_id , sdirk3_dt_max_factor )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_dt_max_factor
  INTEGER id_id
  sdirk3_dt_max_factor = model_config_rec%sdirk3_dt_max_factor
  RETURN
END SUBROUTINE nl_get_sdirk3_dt_max_factor
SUBROUTINE nl_get_sdirk3_safety_factor ( id_id , sdirk3_safety_factor )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_safety_factor
  INTEGER id_id
  sdirk3_safety_factor = model_config_rec%sdirk3_safety_factor
  RETURN
END SUBROUTINE nl_get_sdirk3_safety_factor
SUBROUTINE nl_get_sdirk3_adaptive_dt ( id_id , sdirk3_adaptive_dt )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_adaptive_dt
  INTEGER id_id
  sdirk3_adaptive_dt = model_config_rec%sdirk3_adaptive_dt
  RETURN
END SUBROUTINE nl_get_sdirk3_adaptive_dt
SUBROUTINE nl_get_sdirk3_adaptive_timestep ( id_id , sdirk3_adaptive_timestep )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_adaptive_timestep
  INTEGER id_id
  sdirk3_adaptive_timestep = model_config_rec%sdirk3_adaptive_timestep
  RETURN
END SUBROUTINE nl_get_sdirk3_adaptive_timestep
SUBROUTINE nl_get_sdirk3_error_tol ( id_id , sdirk3_error_tol )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_error_tol
  INTEGER id_id
  sdirk3_error_tol = model_config_rec%sdirk3_error_tol
  RETURN
END SUBROUTINE nl_get_sdirk3_error_tol
SUBROUTINE nl_get_sdirk3_error_norm_type ( id_id , sdirk3_error_norm_type )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_error_norm_type
  INTEGER id_id
  sdirk3_error_norm_type = model_config_rec%sdirk3_error_norm_type
  RETURN
END SUBROUTINE nl_get_sdirk3_error_norm_type
SUBROUTINE nl_get_sdirk3_use_embedding ( id_id , sdirk3_use_embedding )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_use_embedding
  INTEGER id_id
  sdirk3_use_embedding = model_config_rec%sdirk3_use_embedding
  RETURN
END SUBROUTINE nl_get_sdirk3_use_embedding
SUBROUTINE nl_get_sdirk3_use_adaptive_tol ( id_id , sdirk3_use_adaptive_tol )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_use_adaptive_tol
  INTEGER id_id
  sdirk3_use_adaptive_tol = model_config_rec%sdirk3_use_adaptive_tol
  RETURN
END SUBROUTINE nl_get_sdirk3_use_adaptive_tol
...
SUBROUTINE nl_get_windfarm_wake_model ( id_id , windfarm_wake_model )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: windfarm_wake_model
  INTEGER id_id
  windfarm_wake_model = model_config_rec%windfarm_wake_model(id_id)
  RETURN
END SUBROUTINE nl_get_windfarm_wake_model
SUBROUTINE nl_get_windfarm_overlap_method ( id_id , windfarm_overlap_method )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: windfarm_overlap_method
  INTEGER id_id
  windfarm_overlap_method = model_config_rec%windfarm_overlap_method(id_id)
  RETURN
END SUBROUTINE nl_get_windfarm_overlap_method
SUBROUTINE nl_get_windfarm_deg ( id_id , windfarm_deg )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: windfarm_deg
  INTEGER id_id
  windfarm_deg = model_config_rec%windfarm_deg(id_id)
  RETURN
END SUBROUTINE nl_get_windfarm_deg
SUBROUTINE nl_get_use_implicit_scheme ( id_id , use_implicit_scheme )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: use_implicit_scheme
  INTEGER id_id
  use_implicit_scheme = model_config_rec%use_implicit_scheme
  RETURN
END SUBROUTINE nl_get_use_implicit_scheme
SUBROUTINE nl_get_implicit_acoustic ( id_id , implicit_acoustic )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: implicit_acoustic
  INTEGER id_id
  implicit_acoustic = model_config_rec%implicit_acoustic
  RETURN
END SUBROUTINE nl_get_implicit_acoustic
SUBROUTINE nl_get_dynamics_option ( id_id , dynamics_option )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: dynamics_option
  INTEGER id_id
  dynamics_option = model_config_rec%dynamics_option
  RETURN
END SUBROUTINE nl_get_dynamics_option
SUBROUTINE nl_get_sdirk3_newton_rtol ( id_id , sdirk3_newton_rtol )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_newton_rtol
  INTEGER id_id
  sdirk3_newton_rtol = model_config_rec%sdirk3_newton_rtol
  RETURN
END SUBROUTINE nl_get_sdirk3_newton_rtol
SUBROUTINE nl_get_sdirk3_newton_tol_relax ( id_id , sdirk3_newton_tol_relax )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_newton_tol_relax
  INTEGER id_id
  sdirk3_newton_tol_relax = model_config_rec%sdirk3_newton_tol_relax
  RETURN
END SUBROUTINE nl_get_sdirk3_newton_tol_relax
SUBROUTINE nl_get_sdirk3_gmres_restart ( id_id , sdirk3_gmres_restart )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_gmres_restart
  INTEGER id_id
  sdirk3_gmres_restart = model_config_rec%sdirk3_gmres_restart
  RETURN
END SUBROUTINE nl_get_sdirk3_gmres_restart
SUBROUTINE nl_get_sdirk3_max_krylov_iter ( id_id , sdirk3_max_krylov_iter )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_max_krylov_iter
  INTEGER id_id
  sdirk3_max_krylov_iter = model_config_rec%sdirk3_max_krylov_iter
  RETURN
END SUBROUTINE nl_get_sdirk3_max_krylov_iter
SUBROUTINE nl_get_sdirk3_krylov_tol ( id_id , sdirk3_krylov_tol )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_krylov_tol
  INTEGER id_id
  sdirk3_krylov_tol = model_config_rec%sdirk3_krylov_tol
  RETURN
END SUBROUTINE nl_get_sdirk3_krylov_tol
SUBROUTINE nl_get_sdirk3_max_gmres_iter ( id_id , sdirk3_max_gmres_iter )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_max_gmres_iter
  INTEGER id_id
  sdirk3_max_gmres_iter = model_config_rec%sdirk3_max_gmres_iter
  RETURN
END SUBROUTINE nl_get_sdirk3_max_gmres_iter
SUBROUTINE nl_get_sdirk3_gmres_tol ( id_id , sdirk3_gmres_tol )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_gmres_tol
  INTEGER id_id
  sdirk3_gmres_tol = model_config_rec%sdirk3_gmres_tol
  RETURN
END SUBROUTINE nl_get_sdirk3_gmres_tol
SUBROUTINE nl_get_sdirk3_precond_type ( id_id , sdirk3_precond_type )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_precond_type
  INTEGER id_id
  sdirk3_precond_type = model_config_rec%sdirk3_precond_type
  RETURN
END SUBROUTINE nl_get_sdirk3_precond_type
SUBROUTINE nl_get_sdirk3_precond_mu_coupling_damping ( id_id , sdirk3_precond_mu_coupling_damping )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_precond_mu_coupling_damping
  INTEGER id_id
  sdirk3_precond_mu_coupling_damping = model_config_rec%sdirk3_precond_mu_coupling_damping
  RETURN
END SUBROUTINE nl_get_sdirk3_precond_mu_coupling_damping
SUBROUTINE nl_get_sdirk3_reuse_jacobian ( id_id , sdirk3_reuse_jacobian )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_reuse_jacobian
  INTEGER id_id
  sdirk3_reuse_jacobian = model_config_rec%sdirk3_reuse_jacobian
  RETURN
END SUBROUTINE nl_get_sdirk3_reuse_jacobian
SUBROUTINE nl_get_sdirk3_n_threads ( id_id , sdirk3_n_threads )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_n_threads
  INTEGER id_id
  sdirk3_n_threads = model_config_rec%sdirk3_n_threads
  RETURN
END SUBROUTINE nl_get_sdirk3_n_threads
SUBROUTINE nl_get_sdirk3_use_autograd ( id_id , sdirk3_use_autograd )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_use_autograd
  INTEGER id_id
  sdirk3_use_autograd = model_config_rec%sdirk3_use_autograd
  RETURN
END SUBROUTINE nl_get_sdirk3_use_autograd
SUBROUTINE nl_get_sdirk3_use_jvp_cache ( id_id , sdirk3_use_jvp_cache )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_use_jvp_cache
  INTEGER id_id
  sdirk3_use_jvp_cache = model_config_rec%sdirk3_use_jvp_cache
  RETURN
END SUBROUTINE nl_get_sdirk3_use_jvp_cache
SUBROUTINE nl_get_sdirk3_jvp_method ( id_id , sdirk3_jvp_method )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_jvp_method
  INTEGER id_id
  sdirk3_jvp_method = model_config_rec%sdirk3_jvp_method
  RETURN
END SUBROUTINE nl_get_sdirk3_jvp_method
SUBROUTINE nl_get_sdirk3_jvp_epsilon ( id_id , sdirk3_jvp_epsilon )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_jvp_epsilon
  INTEGER id_id
  sdirk3_jvp_epsilon = model_config_rec%sdirk3_jvp_epsilon
  RETURN
END SUBROUTINE nl_get_sdirk3_jvp_epsilon
SUBROUTINE nl_get_sdirk3_cache_graphs ( id_id , sdirk3_cache_graphs )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_cache_graphs
  INTEGER id_id
  sdirk3_cache_graphs = model_config_rec%sdirk3_cache_graphs
  RETURN
END SUBROUTINE nl_get_sdirk3_cache_graphs
SUBROUTINE nl_get_sdirk3_graph_opt_level ( id_id , sdirk3_graph_opt_level )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_graph_opt_level
  INTEGER id_id
  sdirk3_graph_opt_level = model_config_rec%sdirk3_graph_opt_level
  RETURN
END SUBROUTINE nl_get_sdirk3_graph_opt_level
SUBROUTINE nl_get_sdirk3_debug_level ( id_id , sdirk3_debug_level )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_debug_level
  INTEGER id_id
  sdirk3_debug_level = model_config_rec%sdirk3_debug_level
  RETURN
END SUBROUTINE nl_get_sdirk3_debug_level
SUBROUTINE nl_get_sdirk3_check_nan ( id_id , sdirk3_check_nan )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_check_nan
  INTEGER id_id
  sdirk3_check_nan = model_config_rec%sdirk3_check_nan
  RETURN
END SUBROUTINE nl_get_sdirk3_check_nan
SUBROUTINE nl_get_sdirk3_verbose ( id_id , sdirk3_verbose )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_verbose
  INTEGER id_id
  sdirk3_verbose = model_config_rec%sdirk3_verbose
  RETURN
END SUBROUTINE nl_get_sdirk3_verbose
SUBROUTINE nl_get_sdirk3_check_conservation ( id_id , sdirk3_check_conservation )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_check_conservation
  INTEGER id_id
  sdirk3_check_conservation = model_config_rec%sdirk3_check_conservation
  RETURN
END SUBROUTINE nl_get_sdirk3_check_conservation
SUBROUTINE nl_get_sdirk3_print_frequency ( id_id , sdirk3_print_frequency )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_print_frequency
  INTEGER id_id
  sdirk3_print_frequency = model_config_rec%sdirk3_print_frequency
  RETURN
END SUBROUTINE nl_get_sdirk3_print_frequency
SUBROUTINE nl_get_sdirk3_print_stats ( id_id , sdirk3_print_stats )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_print_stats
  INTEGER id_id
  sdirk3_print_stats = model_config_rec%sdirk3_print_stats
  RETURN
END SUBROUTINE nl_get_sdirk3_print_stats
SUBROUTINE nl_get_sdirk3_advection_order ( id_id , sdirk3_advection_order )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_advection_order
  INTEGER id_id
  sdirk3_advection_order = model_config_rec%sdirk3_advection_order
  RETURN
END SUBROUTINE nl_get_sdirk3_advection_order
SUBROUTINE nl_get_sdirk3_diffusion_option ( id_id , sdirk3_diffusion_option )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_diffusion_option
  INTEGER id_id
  sdirk3_diffusion_option = model_config_rec%sdirk3_diffusion_option
  RETURN
END SUBROUTINE nl_get_sdirk3_diffusion_option
SUBROUTINE nl_get_sdirk3_diff_coef_h ( id_id , sdirk3_diff_coef_h )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_diff_coef_h
  INTEGER id_id
  sdirk3_diff_coef_h = model_config_rec%sdirk3_diff_coef_h
  RETURN
END SUBROUTINE nl_get_sdirk3_diff_coef_h
SUBROUTINE nl_get_sdirk3_diff_coef_v ( id_id , sdirk3_diff_coef_v )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_diff_coef_v
  INTEGER id_id
  sdirk3_diff_coef_v = model_config_rec%sdirk3_diff_coef_v
  RETURN
END SUBROUTINE nl_get_sdirk3_diff_coef_v
SUBROUTINE nl_get_sdirk3_diff4_coef ( id_id , sdirk3_diff4_coef )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_diff4_coef
  INTEGER id_id
  sdirk3_diff4_coef = model_config_rec%sdirk3_diff4_coef
  RETURN
END SUBROUTINE nl_get_sdirk3_diff4_coef
SUBROUTINE nl_get_sdirk3_lateral_bc_option ( id_id , sdirk3_lateral_bc_option )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_lateral_bc_option
  INTEGER id_id
  sdirk3_lateral_bc_option = model_config_rec%sdirk3_lateral_bc_option
  RETURN
END SUBROUTINE nl_get_sdirk3_lateral_bc_option
SUBROUTINE nl_get_sdirk3_top_bc_option ( id_id , sdirk3_top_bc_option )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: sdirk3_top_bc_option
  INTEGER id_id
  sdirk3_top_bc_option = model_config_rec%sdirk3_top_bc_option
  RETURN
END SUBROUTINE nl_get_sdirk3_top_bc_option
SUBROUTINE nl_get_sdirk3_rayleigh_coef ( id_id , sdirk3_rayleigh_coef )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_rayleigh_coef
  INTEGER id_id
  sdirk3_rayleigh_coef = model_config_rec%sdirk3_rayleigh_coef
  RETURN
END SUBROUTINE nl_get_sdirk3_rayleigh_coef
SUBROUTINE nl_get_sdirk3_rayleigh_depth ( id_id , sdirk3_rayleigh_depth )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_rayleigh_depth
  INTEGER id_id
  sdirk3_rayleigh_depth = model_config_rec%sdirk3_rayleigh_depth
  RETURN
END SUBROUTINE nl_get_sdirk3_rayleigh_depth
SUBROUTINE nl_get_sdirk3_check_cfl ( id_id , sdirk3_check_cfl )
  USE module_configure, ONLY : model_config_rec 
  logical , INTENT(OUT) :: sdirk3_check_cfl
  INTEGER id_id
  sdirk3_check_cfl = model_config_rec%sdirk3_check_cfl
  RETURN
END SUBROUTINE nl_get_sdirk3_check_cfl
SUBROUTINE nl_get_sdirk3_cfl_target ( id_id , sdirk3_cfl_target )
  USE module_configure, ONLY : model_config_rec 
  real , INTENT(OUT) :: sdirk3_cfl_target
  INTEGER id_id
  sdirk3_cfl_target = model_config_rec%sdirk3_cfl_target
  RETURN
END SUBROUTINE nl_get_sdirk3_cfl_target
SUBROUTINE nl_get_acoustic_ad_mode ( id_id , acoustic_ad_mode )
  USE module_configure, ONLY : model_config_rec 
  integer , INTENT(OUT) :: acoustic_ad_mode
  INTEGER id_id
  acoustic_ad_mode = model_config_rec%acoustic_ad_mode
  RETURN
END SUBROUTINE nl_get_acoustic_ad_mode
