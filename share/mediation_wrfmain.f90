...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % use_sh_qv                  = model_config_rec % use_sh_qv 
 ...
 grid % write_thompson_mp38table   = model_config_rec % write_thompson_mp38table 
 grid % mp_physics                 = model_config_rec % mp_physics (grid%id)
 grid % nssl_cccn                  = model_config_rec % nssl_cccn 
 grid % nssl_alphah                = model_config_rec % nssl_alphah 
 grid % nssl_alphahl               = model_config_rec % nssl_alphahl 
 grid % nssl_cnoh                  = model_config_rec % nssl_cnoh 
 grid % nssl_cnohl                 = model_config_rec % nssl_cnohl 
 grid % nssl_cnor                  = model_config_rec % nssl_cnor 
 grid % nssl_cnos                  = model_config_rec % nssl_cnos 
 grid % nssl_rho_qh                = model_config_rec % nssl_rho_qh 
 grid % nssl_rho_qhl               = model_config_rec % nssl_rho_qhl 
 grid % nssl_rho_qs                = model_config_rec % nssl_rho_qs 
 grid % nssl_icdx                  = model_config_rec % nssl_icdx 
 grid % nssl_icdxhl                = model_config_rec % nssl_icdxhl 
 grid % nssl_hail_on               = model_config_rec % nssl_hail_on 
 grid % nssl_ccn_on                = model_config_rec % nssl_ccn_on 
 grid % nssl_ccn_is_ccna           = model_config_rec % nssl_ccn_is_ccna 
 grid % nssl_2moment_on            = model_config_rec % nssl_2moment_on 
 grid % nssl_3moment               = model_config_rec % nssl_3moment 
 grid % nssl_density_on            = model_config_rec % nssl_density_on 
 grid % nssl_ssat_output           = model_config_rec % nssl_ssat_output 
 ...
 grid % tke_budget                 = model_config_rec % tke_budget (grid%id)
 ...
 grid % bl_mynn_closure            = model_config_rec % bl_mynn_closure 
 ...
 grid % default_soiltype           = model_config_rec % default_soiltype 
 ...
 grid % slucm_distributed_drag     = model_config_rec % slucm_distributed_drag 
 grid % distributed_ahe_opt        = model_config_rec % distributed_ahe_opt 
 grid % num_soil_cat               = model_config_rec % num_soil_cat 
 grid % mp_zero_out                = model_config_rec % mp_zero_out 
 grid % mp_zero_out_all            = model_config_rec % mp_zero_out_all 
 ...
 grid % time_integration_scheme    = model_config_rec % time_integration_scheme 
 grid % sdirk3_max_newton_iter     = model_config_rec % sdirk3_max_newton_iter 
 grid % sdirk3_newton_tol          = model_config_rec % sdirk3_newton_tol 
 grid % sdirk3_dt_min_factor       = model_config_rec % sdirk3_dt_min_factor 
 grid % sdirk3_dt_max_factor       = model_config_rec % sdirk3_dt_max_factor 
 grid % sdirk3_safety_factor       = model_config_rec % sdirk3_safety_factor 
 grid % sdirk3_adaptive_dt         = model_config_rec % sdirk3_adaptive_dt 
 grid % sdirk3_adaptive_timestep   = model_config_rec % sdirk3_adaptive_timestep 
 grid % sdirk3_error_tol           = model_config_rec % sdirk3_error_tol 
 grid % sdirk3_error_norm_type     = model_config_rec % sdirk3_error_norm_type 
 grid % sdirk3_use_embedding       = model_config_rec % sdirk3_use_embedding 
 grid % sdirk3_use_adaptive_tol    = model_config_rec % sdirk3_use_adaptive_tol 
 ...
 grid % windfarm_wake_model        = model_config_rec % windfarm_wake_model (grid%id)
 grid % windfarm_overlap_method    = model_config_rec % windfarm_overlap_method (grid%id)
 grid % windfarm_deg               = model_config_rec % windfarm_deg (grid%id)
 grid % use_implicit_scheme        = model_config_rec % use_implicit_scheme 
 grid % implicit_acoustic          = model_config_rec % implicit_acoustic 
 grid % dynamics_option            = model_config_rec % dynamics_option 
 grid % sdirk3_newton_rtol         = model_config_rec % sdirk3_newton_rtol 
 grid % sdirk3_newton_tol_relax    = model_config_rec % sdirk3_newton_tol_relax 
 grid % sdirk3_gmres_restart       = model_config_rec % sdirk3_gmres_restart 
 grid % sdirk3_max_krylov_iter     = model_config_rec % sdirk3_max_krylov_iter 
 grid % sdirk3_krylov_tol          = model_config_rec % sdirk3_krylov_tol 
 grid % sdirk3_max_gmres_iter      = model_config_rec % sdirk3_max_gmres_iter 
 grid % sdirk3_gmres_tol           = model_config_rec % sdirk3_gmres_tol 
 grid % sdirk3_precond_type        = model_config_rec % sdirk3_precond_type 
 grid % sdirk3_precond_mu_coupling_damping = model_config_rec % sdirk3_precond_mu_coupling_damping 
 grid % sdirk3_reuse_jacobian      = model_config_rec % sdirk3_reuse_jacobian 
 grid % sdirk3_n_threads           = model_config_rec % sdirk3_n_threads 
 grid % sdirk3_use_autograd        = model_config_rec % sdirk3_use_autograd 
 grid % sdirk3_use_jvp_cache       = model_config_rec % sdirk3_use_jvp_cache 
 grid % sdirk3_jvp_method          = model_config_rec % sdirk3_jvp_method 
 grid % sdirk3_jvp_epsilon         = model_config_rec % sdirk3_jvp_epsilon 
 grid % sdirk3_cache_graphs        = model_config_rec % sdirk3_cache_graphs 
 grid % sdirk3_graph_opt_level     = model_config_rec % sdirk3_graph_opt_level 
 grid % sdirk3_debug_level         = model_config_rec % sdirk3_debug_level 
 grid % sdirk3_check_nan           = model_config_rec % sdirk3_check_nan 
 grid % sdirk3_verbose             = model_config_rec % sdirk3_verbose 
 grid % sdirk3_check_conservation  = model_config_rec % sdirk3_check_conservation 
 grid % sdirk3_print_frequency     = model_config_rec % sdirk3_print_frequency 
 grid % sdirk3_print_stats         = model_config_rec % sdirk3_print_stats 
 grid % sdirk3_advection_order     = model_config_rec % sdirk3_advection_order 
 grid % sdirk3_diffusion_option    = model_config_rec % sdirk3_diffusion_option 
 grid % sdirk3_diff_coef_h         = model_config_rec % sdirk3_diff_coef_h 
 grid % sdirk3_diff_coef_v         = model_config_rec % sdirk3_diff_coef_v 
 grid % sdirk3_diff4_coef          = model_config_rec % sdirk3_diff4_coef 
 grid % sdirk3_lateral_bc_option   = model_config_rec % sdirk3_lateral_bc_option 
 grid % sdirk3_top_bc_option       = model_config_rec % sdirk3_top_bc_option 
 grid % sdirk3_rayleigh_coef       = model_config_rec % sdirk3_rayleigh_coef 
 grid % sdirk3_rayleigh_depth      = model_config_rec % sdirk3_rayleigh_depth 
 grid % sdirk3_check_cfl           = model_config_rec % sdirk3_check_cfl 
 grid % sdirk3_cfl_target          = model_config_rec % sdirk3_cfl_target 
 grid % acoustic_ad_mode           = model_config_rec % acoustic_ad_mode 
 ...
 grid % adios2_compression_enable  = model_config_rec % adios2_compression_enable 
 grid % adios2_blosc_compressor    = model_config_rec % adios2_blosc_compressor 
 grid % adios2_numaggregators      = model_config_rec % adios2_numaggregators 
 ...
 grid % fire_sfc_flx               = model_config_rec % fire_sfc_flx (grid%id)
 grid % fire_heat_peak             = model_config_rec % fire_heat_peak (grid%id)
 grid % fire_tg_ub                 = model_config_rec % fire_tg_ub (grid%id)
 grid % fire_smk_scheme            = model_config_rec % fire_smk_scheme (grid%id)
 grid % fire_smk_peak              = model_config_rec % fire_smk_peak (grid%id)
 grid % fire_smk_ext               = model_config_rec % fire_smk_ext (grid%id)
 ...
 grid % trackember                 = model_config_rec % trackember 
 ...
 grid % iau                        = model_config_rec % iau (grid%id)
 grid % iau_time_window_sec        = model_config_rec % iau_time_window_sec (grid%id)
 ...
 grid % sdirk3_jvp_checkpointing   = model_config_rec % sdirk3_jvp_checkpointing 
 grid % sdirk3_jvp_checkpoint_segments = model_config_rec % sdirk3_jvp_checkpoint_segments 
 grid % sdirk3_jvp_graph_caching   = model_config_rec % sdirk3_jvp_graph_caching 
 grid % sdirk3_jvp_batched         = model_config_rec % sdirk3_jvp_batched 
 grid % sdirk3_jvp_batch_size      = model_config_rec % sdirk3_jvp_batch_size 
 grid % sdirk3_jvp_mixed_precision = model_config_rec % sdirk3_jvp_mixed_precision 
 grid % sdirk3_implicit_acoustic   = model_config_rec % sdirk3_implicit_acoustic 
 grid % sdirk3_implicit_gravity    = model_config_rec % sdirk3_implicit_gravity 
 grid % sdirk3_implicit_rayleigh   = model_config_rec % sdirk3_implicit_rayleigh 
 grid % sdirk3_implicit_wdamp      = model_config_rec % sdirk3_implicit_wdamp 
 grid % sdirk3_implicit_vdiff      = model_config_rec % sdirk3_implicit_vdiff 
 grid % sdirk3_implicit_hdiff      = model_config_rec % sdirk3_implicit_hdiff 
 grid % sdirk3_implicit_divergence = model_config_rec % sdirk3_implicit_divergence 
 grid % sdirk3_precond_diagonal_only = model_config_rec % sdirk3_precond_diagonal_only 
 grid % sdirk3_precond_block_jacobi = model_config_rec % sdirk3_precond_block_jacobi 
 grid % sdirk3_precond_block_size  = model_config_rec % sdirk3_precond_block_size 
 grid % sdirk3_precond_ilu         = model_config_rec % sdirk3_precond_ilu 
 grid % sdirk3_precond_ilu_level   = model_config_rec % sdirk3_precond_ilu_level 
 grid % sdirk3_precond_multigrid   = model_config_rec % sdirk3_precond_multigrid 
 grid % sdirk3_precond_mg_levels   = model_config_rec % sdirk3_precond_mg_levels 
 grid % sdirk3_nk_adaptive_tol     = model_config_rec % sdirk3_nk_adaptive_tol 
 grid % sdirk3_nk_forcing_eta_max  = model_config_rec % sdirk3_nk_forcing_eta_max 
 grid % sdirk3_nk_forcing_eta_min  = model_config_rec % sdirk3_nk_forcing_eta_min 
 grid % sdirk3_nk_forcing_gamma    = model_config_rec % sdirk3_nk_forcing_gamma 
 grid % sdirk3_nk_forcing_alpha    = model_config_rec % sdirk3_nk_forcing_alpha 
 grid % sdirk3_nk_line_search      = model_config_rec % sdirk3_nk_line_search 
 grid % sdirk3_nk_trust_region     = model_config_rec % sdirk3_nk_trust_region 
 grid % sdirk3_nk_trust_radius     = model_config_rec % sdirk3_nk_trust_radius 
 grid % sdirk3_stage2_gmres_restart = model_config_rec % sdirk3_stage2_gmres_restart 
 grid % sdirk3_stage2_max_krylov_restarts = model_config_rec % sdirk3_stage2_max_krylov_restarts 
 grid % sdirk3_stage2_krylov_tol   = model_config_rec % sdirk3_stage2_krylov_tol 
 grid % sdirk3_stage2_ew_eta_min   = model_config_rec % sdirk3_stage2_ew_eta_min 
 grid % sdirk3_stage2_ew_eta_max   = model_config_rec % sdirk3_stage2_ew_eta_max 
 grid % sdirk3_stage3_gmres_restart = model_config_rec % sdirk3_stage3_gmres_restart 
 grid % sdirk3_stage3_max_krylov_restarts = model_config_rec % sdirk3_stage3_max_krylov_restarts 
 grid % sdirk3_stage3_krylov_tol   = model_config_rec % sdirk3_stage3_krylov_tol 
 grid % sdirk3_stage3_ew_eta_min   = model_config_rec % sdirk3_stage3_ew_eta_min 
 grid % sdirk3_stage3_ew_eta_max   = model_config_rec % sdirk3_stage3_ew_eta_max 
 grid % sdirk3_imex_split_mode     = model_config_rec % sdirk3_imex_split_mode 
 grid % sdirk3_imex_slow_in_tangent = model_config_rec % sdirk3_imex_slow_in_tangent 
 grid % sdirk3_imex_phys_in_tangent = model_config_rec % sdirk3_imex_phys_in_tangent 
 grid % sdirk3_stage1_explicit     = model_config_rec % sdirk3_stage1_explicit 
 grid % sdirk3_stage3_warmstart    = model_config_rec % sdirk3_stage3_warmstart 
 grid % sdirk3_stage_fail_action   = model_config_rec % sdirk3_stage_fail_action 
 grid % sdirk3_gate_metric_mode    = model_config_rec % sdirk3_gate_metric_mode 
 grid % sdirk3_stage3_gate_rel_threshold = model_config_rec % sdirk3_stage3_gate_rel_threshold 
 grid % sdirk3_hopeless_relax      = model_config_rec % sdirk3_hopeless_relax 
 grid % sdirk3_precond_ratio_guard_warn_only = model_config_rec % sdirk3_precond_ratio_guard_warn_only 
 grid % sdirk3_retain_graph_for_adjoint = model_config_rec % sdirk3_retain_graph_for_adjoint 
 grid % sdirk3_enable_ad_halo_exchange = model_config_rec % sdirk3_enable_ad_halo_exchange 
 grid % sdirk3_stage_boundary_sync = model_config_rec % sdirk3_stage_boundary_sync 
 grid % sdirk3_jvp_auto_bench_calls = model_config_rec % sdirk3_jvp_auto_bench_calls 
 grid % sdirk3_jvp_auto_bench_quality_gate = model_config_rec % sdirk3_jvp_auto_bench_quality_gate 
 grid % sdirk3_jvp_auto_bench_warmup = model_config_rec % sdirk3_jvp_auto_bench_warmup 
 grid % sdirk3_jvp_auto_bench_seed = model_config_rec % sdirk3_jvp_auto_bench_seed 
 grid % sdirk3_jvp_auto_bench_lock_reset_stage1 = model_config_rec % sdirk3_jvp_auto_bench_lock_reset_stage1 
 grid % sdirk3_solver_telemetry    = model_config_rec % sdirk3_solver_telemetry 
 grid % sdirk3_progress_invariant_enable = model_config_rec % sdirk3_progress_invariant_enable 
 grid % sdirk3_progress_invariant_min_ratio = model_config_rec % sdirk3_progress_invariant_min_ratio 
 grid % sdirk3_progress_invariant_streak_limit = model_config_rec % sdirk3_progress_invariant_streak_limit 
 grid % sdirk3_variable_pc_event_log = model_config_rec % sdirk3_variable_pc_event_log 
 grid % sdirk3_gmres_warmstart     = model_config_rec % sdirk3_gmres_warmstart 
 grid % sdirk3_gmres_warmstart_quality_gate = model_config_rec % sdirk3_gmres_warmstart_quality_gate 
 grid % sdirk3_inn_warmstart_enable = model_config_rec % sdirk3_inn_warmstart_enable 
 grid % sdirk3_inn_residual_gate_enable = model_config_rec % sdirk3_inn_residual_gate_enable 
 grid % sdirk3_inn_q_min           = model_config_rec % sdirk3_inn_q_min 
 grid % sdirk3_inn_gate_rel_tol    = model_config_rec % sdirk3_inn_gate_rel_tol 
 grid % sdirk3_inn_gate_q_noise    = model_config_rec % sdirk3_inn_gate_q_noise 
 grid % sdirk3_inn_beta_max        = model_config_rec % sdirk3_inn_beta_max 
 grid % sdirk3_inn_ood_guard_enable = model_config_rec % sdirk3_inn_ood_guard_enable 
 grid % sdirk3_inn_tol_ramp_enable = model_config_rec % sdirk3_inn_tol_ramp_enable 
 grid % sdirk3_inn_tol_ramp_gamma  = model_config_rec % sdirk3_inn_tol_ramp_gamma 
 grid % sdirk3_rhs_bc_parity       = model_config_rec % sdirk3_rhs_bc_parity 
 grid % sdirk3_mass_pgf_bc_guard   = model_config_rec % sdirk3_mass_pgf_bc_guard 
 grid % sdirk3_precond_horizontal_smooth_alpha = model_config_rec % sdirk3_precond_horizontal_smooth_alpha 
 grid % sdirk3_precond_horizontal_smooth_iters = model_config_rec % sdirk3_precond_horizontal_smooth_iters 
 grid % sdirk3_precond_vertical_smooth_alpha = model_config_rec % sdirk3_precond_vertical_smooth_alpha 
 grid % sdirk3_precond_smooth_boundary_guard = model_config_rec % sdirk3_precond_smooth_boundary_guard 
 grid % sdirk3_trust_region_block_aware_thresh = model_config_rec % sdirk3_trust_region_block_aware_thresh 
 grid % sdirk3_trust_fallback_relax = model_config_rec % sdirk3_trust_fallback_relax 
 grid % sdirk3_trust_fallback_ratio = model_config_rec % sdirk3_trust_fallback_ratio 
 grid % sdirk3_direct_u_solve_thresh = model_config_rec % sdirk3_direct_u_solve_thresh 
 grid % sdirk3_memory_pool         = model_config_rec % sdirk3_memory_pool 
 grid % sdirk3_memory_pool_size_mb = model_config_rec % sdirk3_memory_pool_size_mb 
 grid % sdirk3_tensor_checkpointing = model_config_rec % sdirk3_tensor_checkpointing 
 grid % sdirk3_gradient_checkpointing = model_config_rec % sdirk3_gradient_checkpointing 
 grid % sdirk3_kdamp               = model_config_rec % sdirk3_kdamp 
 grid % sdirk3_khdif               = model_config_rec % sdirk3_khdif 
 grid % sdirk3_kvdif               = model_config_rec % sdirk3_kvdif 
 grid % sdirk3_w_damp_alpha        = model_config_rec % sdirk3_w_damp_alpha 
 grid % sdirk3_w_crit_cfl          = model_config_rec % sdirk3_w_crit_cfl 
 grid % sdirk3_validation_level    = model_config_rec % sdirk3_validation_level 
 grid % sdirk3_check_staggered     = model_config_rec % sdirk3_check_staggered 
 grid % sdirk3_collect_stats       = model_config_rec % sdirk3_collect_stats 
 grid % sdirk3_conserv_tol_mass    = model_config_rec % sdirk3_conserv_tol_mass 
 grid % sdirk3_conserv_tol_energy  = model_config_rec % sdirk3_conserv_tol_energy 
 grid % sdirk3_conserv_tol_momentum = model_config_rec % sdirk3_conserv_tol_momentum 
 grid % sdirk3_enable_benchmarking = model_config_rec % sdirk3_enable_benchmarking 
 grid % sdirk3_benchmark_warmup    = model_config_rec % sdirk3_benchmark_warmup 
 grid % sdirk3_benchmark_measure   = model_config_rec % sdirk3_benchmark_measure 
 grid % sdirk3_save_trajectory     = model_config_rec % sdirk3_save_trajectory 
 grid % sdirk3_checkpoint_interval = model_config_rec % sdirk3_checkpoint_interval 
 grid % sdirk3_obs_aware_4dvar     = model_config_rec % sdirk3_obs_aware_4dvar 
 grid % sdirk3_obs_source_mode     = model_config_rec % sdirk3_obs_source_mode 
 grid % sdirk3_obs_window_sync_mode = model_config_rec % sdirk3_obs_window_sync_mode 
