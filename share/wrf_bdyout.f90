...
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k1 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k1 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BTYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_U_BTYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k1 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k1 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BTXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BTXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_V_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k1 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k1 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_W_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k1 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k1 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_T_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k1 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k1 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_PH_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy SDIRK-3 k1 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k1 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy tend SDIRK-3 k1 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BTXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BTXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BTYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k1 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K1_MU_BTYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k2 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k2 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BTYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_U_BTYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k2 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k2 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BTXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BTXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_V_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k2 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k2 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_W_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k2 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k2 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_T_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k2 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k2 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_PH_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy SDIRK-3 k2 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k2 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy tend SDIRK-3 k2 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BTXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BTXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BTYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k2 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K2_MU_BTYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k3 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for U'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k3 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BTYS memorder YSZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for U'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_U_BTYE memorder YEZ' , & 
1, ide, kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( ide, ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k3 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for V'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k3 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BTXS memorder XSZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BTXE memorder XEZ' , & 
1, jde, kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( jde, jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for V'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_V_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k3 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for W'               , &  
                       'm s-2'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k3 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for W'               , &  
                       '(m s-2)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_W_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k3 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for theta'               , &  
                       'K s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k3 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for theta'               , &  
                       '(K s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_T_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy SDIRK-3 k3 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for phi'               , &  
                       'm2 s-3'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top_stag'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK-3 k3 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BTXS memorder XSZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BTXE memorder XEZ' , & 
1, (jde-1), kds, kde, 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BTYS memorder YSZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for phi'               , &  
                       '(m2 s-3)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_PH_BTYE memorder YEZ' , & 
1, (ide-1), kds, kde, 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, kde, 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy SDIRK-3 k3 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK-3 k3 for mu'               , &  
                       'Pa s-1'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy_width'               , &  
                       'one_element'               , &  
                       'bdy tend SDIRK-3 k3 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BTXS memorder XS' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BTXE memorder XE' , & 
1, (jde-1), 1, config_flags%spec_bdy_width, 1, 1, &
jms, jme, 1, config_flags%spec_bdy_width, 1, 1, &
jps, MIN( (jde-1), jpe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BTYS memorder YS' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK-3 k3 for mu'               , &  
                       '(Pa s-1)/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field K3_MU_BTYE memorder YE' , & 
1, (ide-1), 1, config_flags%spec_bdy_width, 1, 1, &
ims, ime, 1, config_flags%spec_bdy_width, 1, 1, &
ips, MIN( (ide-1), ipe ), 1, config_flags%spec_bdy_width, 1, 1, &
                       ierr )
...
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 1'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 1'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 1'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 1'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK3 stage 1'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 1'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 1'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 1'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K1_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 2'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 2'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 2'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 2'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK3 stage 2'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 2'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 2'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 2'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K2_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 3'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 3'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 3'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy SDIRK3 stage 3'               , &  
                       ''               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bottom_top'               , &  
                       'bdy_width'               , &  
                       'bdy tend SDIRK3 stage 3'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BTXS memorder XSZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 3'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BTXE memorder XEZ' , & 
1, (jde-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
jms, jme, kds, kde, 1, config_flags%spec_bdy_width, &
jps, MIN( (jde-1), jpe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 3'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BTYS memorder YSZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
CALL wrf_ext_write_field (  &
                       ...
                       'bdy tend SDIRK3 stage 3'               , &  
                       '()/dt'               , &  
'inc/wrf_bdyout.inc ext_write_field SDIRK3_K3_BTYE memorder YEZ' , & 
1, (ide-1), kds, (kde-1), 1, config_flags%spec_bdy_width, &
ims, ime, kds, kde, 1, config_flags%spec_bdy_width, &
ips, MIN( (ide-1), ipe ), kds, (kde-1), 1, config_flags%spec_bdy_width, &
                       ierr )
