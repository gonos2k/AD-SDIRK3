...
MODULE module_mp_radar
      ...
      REAL, DIMENSION(4), PUBLIC:: xcre, xcse, xcge, xche, xcrg, xcsg, xcgg, xchg
      ...
      DOUBLE PRECISION, PARAMETER:: melt_outside_h = 0.9d0
...
CONTAINS
      ...
      xche(1) = 1. + xbm_h
      xche(2) = 1. + xmu_h
      xche(3) = 1. + xbm_h + xmu_h
      xche(4) = 1. + 2.*xbm_h + xmu_h
      do n = 1, 4
